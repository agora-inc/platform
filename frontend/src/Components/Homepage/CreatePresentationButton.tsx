...
export const CreatePresentationButton = (props: any) => {
  ...
  return (
    <>
      <Box
        ...
        background="#0C385B"
        round="xsmall"
        pad={props.isMobile ? "30px" : "xsmall"}
        height="80px"
        width={props.isMobile ? "250px" : "310px"}
        justify="center"
        align="center"
        focusIndicator={false}
        hoverIndicator="#BAD6DB"
        direction="row"
        style={{ alignSelf: props.isSmallScreen ? "center" : "" }}
      >
        {props.isMobile ? "" : <Workshop size="30px" />}
        <Text size="18px" margin={{ left: props.isMobile ? "0px" : "10px" }}>
