      ...
      {user && (
        <>
          <OverlaySection>
            ...
            organise and advertise all your events, past or future, and where
            speakers come and apply. Give your community a name and
            classification before getting started!
            <TextInput
