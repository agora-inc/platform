    ...
    return (
      ...
      >
        ...
        >
            ...
            >
              ...
              <Text size="14px" margin={{ left: "10px" }}>
                <b>
                  ...
                  {renderMobileView
                    ? "Browse seminars"
                    : "Browse trending seminars"}{" "}
                </b>
              </Text>
            </Box>
          </Link>

          <Box width="40px" height="30px" round="7px" justify="center">
          ...
          <Box width="40px" height="30px" round="7px" justify="center">
            <a href="https://join.slack.com/t/morastream/shared_invite/zt-13ug7lh9j-4ijI41o0iiGF5cmmZ8osYw">
              <Slack color="plain" />
            </a>
          </Box>
