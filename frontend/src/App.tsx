...
function App() {
  ...
  const smallScreenBreakpoint = 480;

  const [responsiveData, setReponsiveData] = React.useState({
  ...
  */
  ...
  return (
    <Grommet theme={Theme} full>
      ...
      <Switch>
        {/* LANDING PAGES */}
        {/*<Route exact path="/" render={(routeProps) => (<LandingPage {...routeProps} responsiveData={responsiveData} />)} />*/}
