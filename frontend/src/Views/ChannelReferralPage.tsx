...
export default class ChannelReferralPage extends Component<
  RouteComponentProps,
  State
> {
    ...
    this.state = {
      ...
      channelId:
        ...
        Number(this.props.location.pathname.split("/")[3])
          ...
          : 0,
      showAsReferee:
        new URL(window.location.href).searchParams.get("referee") === "true",
      colorButton: "color1",
      colorHover: "color5",
  ...
  fetchChannelAndReferrals = () => {
    ChannelService.getChannelById(this.state.channelId, (channel: Channel) => {
      if (channel) {
        this.setState(
          {
            channel: channel,
      ...
      return (
        <>
          <Text
            ...
            color="grey"
            margin={
              this.state.renderMobileView ? { top: "80px" } : { top: "120px" }
            }
          >
      ...
      if (this.state.channel) {
        ...
        return (
          <>
            ...
            >
              Invite people and empower your community for free
            </Text>
          </>
        );
      }
  ...
  propagationAction() {
    return (
      <Text size="20px" margin={{ top: "80px" }}>
        Share this unique link via email, Facebook, or Twitter and earn exciting
        rewards for each members who signs up.
      </Text>
    );
  }
      ...
      <>
        ...
        >
          <ProgressBar
            ...
            unfilledBackground="grey"
            hasStepZero={true}
            stepPositions={[0, 10, 20, 50, 100]}
            height={10}
          >
            <Step>
              {({
        ...
        <Box
          ...
          align="center"
          margin={{ bottom: "20px" }}
          style={{ minHeight: "30px", position: "relative", zIndex: 1 }}
        >
          <Text weight="bold" color="grey" size="13px">
            {" "}
            Sharing events via Twiter{" "}
          </Text>
          <Text weight="bold" color="grey" size="13px">
            {" "}
      ...
      <>
        <Box>
          ...
          <Box direction="row" gap="xsmall" align="end" width="60%">
            <ShareButtons channel={this.state.channel} referral={true} />
          </Box>
      ...
      <>
        ...
        >
          <video autoPlay loop muted style={{ height: "auto", width: "100%" }}>
            <source
              src="/videos/referral_page_faces_ai_generated.webm"
              type="video/webm"
            />
          </video>
        </Box>
          ...
          <>
            <Box>
              <Text
                ...
                alignSelf="center"
              >
                Keep up with the hottest ideas of the moment!
              </Text>
  ...
  render() {
    if (this.state.loading) {
      return <Loading size={16} color="color1" />;
    } else {
      // if(!this.state.channel){
      //   return(
      ...
      return (
        <Box direction="column" align="center">
          ...
          <Box height="100%" width="100%">
            <Box
              width="80%"
              height={this.state.renderMobileView ? "1480px" : "550px"}
              direction={this.state.renderMobileView ? "column" : "row"}
              alignSelf="center"
            >
              <Box
          ...
          <Box height="100%" width="100%" background="color5" id="content">
            <Box
              width="80%"
              height={this.state.renderMobileView ? "1750px" : "460px"}
              direction="column"
              alignSelf="center"
            >
              {this.content1()}
