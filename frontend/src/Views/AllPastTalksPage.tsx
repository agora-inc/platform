...
import TalksLinks from "../Components/Talks/TalksLinks";
...
export default class AllPastTalksPage extends Component<{}, State> {
  ...
  */
  ...
  render() {
    ...
    let childElements: React.ReactNode[] = this.state.displayedTalks.map(
        ...
        <MediaQuery minDeviceWidth={992}>
          ...
          >
              ...
              {this.getPrimitiveNodes()
                ...
                .map((topic: Topic, index: number) => (
                  <Box
                    ...
                    background={
                      this.state.chosenTopic === topic ? "#0C385B" : "white"
                    }
                    round="xsmall"
                    pad="5px"
                    width="80%"
                ...
                this.getChildren(this.state.chosenTopic)
                  ...
                  .filter((topic: Topic) => {
                    return this.state.audienceLevel.length != 0
                      ...
                      : this.getTalksByTopicOnly(this.state.allTalks, [
                          topic.id,
                        ]).length > 0;
                  })
                  .map((topic: Topic) => (
            ...
            <Box direction="column" width="20%">
              ...
              {this.state.allAudienceLevels.map(
                (txt: string, index: number) => (
                  <Box
                    onClick={() => {
                      this.updateAudienceLevel(txt);
                    }}
                    background={
