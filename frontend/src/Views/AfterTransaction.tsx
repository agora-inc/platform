...
export default class AfterTransaction extends Component<Props, State> {
  ...
  componentDidMount = () => {
    ChannelService.getChannelById(this.state.channel.id, (channel: Channel) => {
      this.setState(
        {
          channel: channel,
    ...
    return (
      <Box align="center" margin={{ top: "80px" }}>
        <Box width="40%">
          ...
          <Text size="36px" alignSelf="center">
            🎉Success!🎉
          </Text>
          <Box>
            <img
              src="/images/academic_seminars_photo.jpeg"
              width="100%"
              style={{
                margin: "20px",
                alignSelf: "center",
          ...
          <Box margin={{ top: "14px" }}>
            ...
            <ul>
              <li>
                ...
                <a href={channelUrl}>
                  {" "}
                  agora page and schedule your next events!
                </a>
              </li>
              <li>
                Attract future participants and speakers by sharing your page on
                social media!
              </li>
              <li>
                Follow us on Twitter and Linkedin to hear about your new
                incoming features!
              </li>
            </ul>
          </Box>
    ...
    return (
      <Box align="center" margin={{ top: "80px" }}>
        <Box width="40%">
          ...
          <Box>
            <img
              src="/images/error_icecream_photo.jpeg"
              width="100%"
              style={{
                margin: "20px",
                alignSelf: "center",
          ...
          {/* Restate value of original offer */}
          <Text size="14px">
            If clearing your cache and trying again did not work, please send a
            short description of your problem to{" "}
            <a href="mailto:team@agora.stream">team@agora.stream</a> and we will
            get this sorted out as soon as possible!
          </Text>
        </Box>
      </Box>
    );
